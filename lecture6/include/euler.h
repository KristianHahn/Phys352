...
double euler_step_2component(TwoComponent* x, double t, double f1, double f2, double dt);

void euler_solver_2component_fp(TwoComponent* x, double* t, 
...
void euler_step_4component(FourComponent* x, double* t, 
			   double fA, double fB, double fC, double fD,  
			   double dt); 

void euler_solver_4component_fp(FourComponent* x, double* t, 

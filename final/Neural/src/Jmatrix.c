...
// ------------------------------------------------------
{
  ...
  // this formulation is quasi-specifc to the modulus operation we're
  // implementing : loop over the (2) output patterns P.  The use the 
  // even or odd input patterns for that P ...
  for (l = 0; l < P; l++) {
    for (k = l; k < M; k+=2 ) {
